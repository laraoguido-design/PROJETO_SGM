...
<body>
   ...
   <div class="container-fluid " style="width:60rem;">
    <a href="servicos_dashboard.php" class="btn btn-outline-dark mt-5" style="">Voltar</a>
  ...
  <div class="row d-flex">
     ...
     <li class="list-group-item">Dados do Serviço</li>

<div class="input-group input-group-sm mb-1">
  <span class="input-group-text" id="inputGroup-sizing-sm"  >Nome</span>
  <input type="text" class="form-control"  required placeholder="Hidrelétrica">
</div>
...
<a href="servico_dashboard.php" type="submit" class="btn btn-success mt-3" style="max-width:5rem;">Salvar</a>
</div>
</form>
