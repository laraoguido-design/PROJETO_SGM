...
<body>
  ...
  <input type="text" class="form-control"  required placeholder="Ex: bloco administrativo">
</div>
  ...
  <input type="text" class="form-control"  >
                     ...
                     <button type="submit" class="btn btn-primary w-40 mt-3">Registrar bloco</button>
                    </div>
