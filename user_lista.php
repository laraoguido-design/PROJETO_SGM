...
<body class="bg-light">
    ...
    <div class="container ">
        <h2 class="mb-4 mt-5">Todos os Usuários</h2>
           <a href="novo_user.php" class="btn btn-outline-primary  w-20">+ Novo Usuário</a>
                    ...
                    <tbody id="tabelaGeral">
                         ...
                         <td>admin@sgm.com</td>
                          ...
                          <td>....</td>
                           <td>....</td>
                            <td>....</td>
                         <td>  <a href="editar_user.php" class="btn btn-primary w-20">
