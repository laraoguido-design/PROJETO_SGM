...
<body class="bg-light">
    ...
    <div class="container ">
        <h2 class="mb-4 mt-5">Todos os Blocos</h2>
           <a href="novo_bloco.php" class="btn btn-outline-primary  w-20">+ Novo Bloco</a>
            ...
            <div class="table-responsive ">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody id="tabelaGeral">
                         ...
                         <td>....</td>
                         <td>  <a href="editar_bloco.php" class="btn btn-primary w-20">
