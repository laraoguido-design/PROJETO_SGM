...
<body class="bg-light">
    ...
    <div class="container ">
        <h2 class="mb-4 mt-5">Todos os Serviços</h2>
           <a href="novo_servico.php" class="btn btn-outline-primary  w-20">+ Novo serviço</a>
            ...
            <div class="table-responsive ">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody id="tabelaGeral">
                         ...
                         <td>Hidráulica</td>
                         <td>....</td>
                         <td>  <a href="editar_servico.php" class="btn btn-primary w-20">
